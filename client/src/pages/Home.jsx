              ...
              <motion.div className="row g-4" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <div className="col-6">
                  <div className="stat-box glass-card border-secondary text-center p-4 rounded-4 h-100">
                    <div className="stat-number text-warning fw-bold display-5 mb-2"><CountUpAnimation to={10} suffix="K+" /></div>
                    <div className="stat-label text-white small text-uppercase">Trips Planned</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="stat-box glass-card border-secondary text-center p-4 rounded-4 h-100">
                    <div className="stat-number text-warning fw-bold display-5 mb-2"><CountUpAnimation to={50} suffix="K+" /></div>
                    <div className="stat-label text-white small text-uppercase">Travel Memories</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="stat-box glass-card border-secondary text-center p-4 rounded-4 h-100">
                    <div className="stat-number text-warning fw-bold display-5 mb-2"><CountUpAnimation to={15} suffix="K+" /></div>
                    <div className="stat-label text-white small text-uppercase">Travelers Connected</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="stat-box glass-card border-secondary text-center p-4 rounded-4 h-100">
                    <div className="stat-number text-warning fw-bold display-5 mb-2"><CountUpAnimation to={95} suffix="%" /></div>
                    <div className="stat-label text-white small text-uppercase">Positive Reviews</div>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      <section className="landing-section" style={{ background: "#050505" }}>
        <div className="container text-center">
          ...
          <motion.div className="row g-4 mt-2" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            {[
              { icon: "robot", title: "AI Travel Assistant", desc: "Get smart recommendations and intelligent travel itineraries." },
              { icon: "handshake", title: "Smart Traveler Matching", desc: "Find companions with matching travel styles." },
              { icon: "users", title: "Live Trip Collaboration", desc: "Plan seamlessly with friends in real-time." },
              { icon: "receipt", title: "Expense Settlement", desc: "Easily split and settle shared trip costs." },
              { icon: "suitcase", title: "AI Packing List", desc: "Never forget essentials with AI-generated lists." },
              { icon: "stream", title: "Travel Timeline", desc: "Log locations and moments chronologically." },
              { icon: "book-open", title: "Travel Story Generator", desc: "Convert memories into beautiful travel stories." },
              { icon: "chart-pie", title: "Analytics Dashboard", desc: "Visualize your travel stats and expenses." }
            ].map((item, index) => (
